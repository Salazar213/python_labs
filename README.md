...
```
Методы update и remove действуют только на одного студента(строгое совпадение с normalize(`fio`)).
Также возвращают `True`/`False` при успешном \ не успешном выполнении

Вот такая база данных 
![im](images/lab09/image01.png)

Пример `add`
![im1](images/lab09/image02.png)

Пример `find`
![im2](images/lab09/image03.png)

Пример `update` 

![im3](images/lab09/image04.png)

Пример `remove`

![im4](images/lab09/image05.png)

Пример `stats`, вывод не очень красивый

![im5](images/lab09/image06.png)
