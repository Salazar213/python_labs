...
paths.add_argument(
    "--input", type=str, default="C:/python_labs_alg/python_labs/data/a.txt", nargs="+"
)
paths.add_argument(
    "--output", type=str, default="C:/python_labs_alg/python_labs/data/out.csv"
)
...
if len(path_in) != 1:
    write_csv(
        rows=[],
        path="C:/python_labs_alg/python_labs/data/reprot_per_file.csv",
    ...
    write_csv(
        rows=result_summa_dict,
        path="C:/python_labs_alg/python_labs/data/report_total.csv",
        header=("word", "count"),
    )
elif len(path_in) == 1:
    path_in = path_in[0]
